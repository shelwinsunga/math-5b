...
export const SolutionB = () => <InlineMath math={'\\ g\'\\left( t \\right) = 12{t^5} - 42{t^{ - 7}}'} />;

export const ProblemC = () => <InlineMath math={'\\displaystyle y = 8{z^3} - \\frac{1}{{3{z^5}}} + z - 23'} />;
export const SolutionC = () => <InlineMath math={'\\displaystyle y\' = 24{z^2} + \\frac{5}{3}{z^{ - 6}} + 1'} />;


export const ProblemD = () => <InlineMath math={'\\displaystyle T\\left( x \\right) = \\sqrt x  + 9\\sqrt[3]{{{x^7}}} - \\frac{2}{{\\sqrt[5]{{{x^2}}}}} '} />;
export const SolutionD = () => <InlineMath math={'\\displaystyle T\'\\left( x \\right) = \\frac{1}{2}{x^{ - \\,\\,\\frac{1}{2}}} + \\frac{{63}}{3}{x^{\\frac{4}{3}}} + \\frac{4}{5}{x^{ - \\,\\,\\frac{7}{5}}}' } />;
